    ...
    <header className="w-full bg-white shadow-sm flex justify-between items-center px-4 py-2 h-14 z-50 border-b border-gray-200">
      ...
      {!user ? (
        <div 
          ...
          className="flex items-center gap-2 cursor-pointer hover:bg-gray-50 px-2 py-1 rounded transition"
        >
        ...
        <div className="flex items-center gap-3">
             <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-emerald-100 text-emerald-700 border border-emerald-200 rounded-full flex items-center justify-center font-bold text-xs shadow-sm">
                    {user.nickname[0]}
                </div>
             ...
             <button 
                ...
                className="text-xs text-red-500 hover:bg-red-50 px-2 py-1 rounded border border-red-100"
             >
                退出
             </button>
        </div>
      ...
      <div 
        ...
        className="flex items-center gap-2 bg-gray-50 px-3 py-1 rounded-full border border-gray-200 cursor-pointer hover:bg-gray-100 transition"
      >
